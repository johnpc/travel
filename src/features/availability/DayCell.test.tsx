...
describe('DayCell', () => {
  it('renders a blank inert cell for a null date', () => {
    const { container } = render(<DayCell date={null} tally={undefined} mine={null} canMark onToggle={vi.fn()} />); // prettier-ignore
  ...
  it('shows the day number and group free-count, and toggles on click', () => {
    ...
    expect(onToggle).toHaveBeenCalledWith('2027-03-05');
  });
